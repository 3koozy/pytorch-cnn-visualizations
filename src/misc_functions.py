...
def save_class_activation_images(org_img, activation_map, file_name, dir_path):
    """
    ...
    path_to_file = os.path.join(dir_path, file_name+'_Cam_Heatmap.png')
    save_image(heatmap, path_to_file)
    # Save heatmap on iamge
    path_to_file = os.path.join(dir_path, file_name+'_Cam_On_Image.png')
    save_image(heatmap_on_image, path_to_file)
    # SAve grayscale heatmap
    path_to_file = os.path.join(dir_path, file_name+'_Cam_Grayscale.png')
